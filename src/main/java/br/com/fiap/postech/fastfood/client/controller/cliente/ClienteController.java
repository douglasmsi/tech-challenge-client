package br.com.fiap.postech.fastfood.client.controller.cliente;
...
import br.com.fiap.postech.fastfood.client.controller.dto.ErrorResponse;
...
public class ClienteController implements ClienteControllerSwagger {
  ...
  public ResponseEntity<Object> getClienteByCpf(@PathVariable(value = "cpf") String cpf) {
    ...
    if (cliente == null) {
      ErrorResponse errorResponse = new ErrorResponse(
          ErrorMessages.CLIENTE_CPF_NOT_FOUND.getMessage());
      return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorResponse);
    }
  ...
  public ResponseEntity<Object> createCliente(@RequestBody Cliente cliente) {
    try {
      ...
      ErrorResponse errorResponse = new ErrorResponse(
          ErrorMessages.CLIENTE_CPF_ALREADY_EXISTS.getMessage());
      return ResponseEntity.status(HttpStatus.CONFLICT).body(errorResponse);
    } catch (Exception ex) {
      ErrorResponse errorResponse = new ErrorResponse(
          ErrorMessages.CLIENTE_ALREADY_EXISTS.getMessage());
