...
class ClienteControllerTest {
  ...
  void whenCreateCliente_shouldReturnConflictCpf() throws Exception {
    ...
    when(criarClienteUseCase.save(any(Cliente.class))).thenThrow(
  ...
  @Test
  void whenCreateCliente_shouldReturnInternalServerError() throws Exception {
    final var cliente = ClienteMock.create();
    final var expectedMessageError = """
        {"message":"Cliente já cadastrado"}
        """;

    when(criarClienteUseCase.save(any(Cliente.class))).thenThrow(new RuntimeException("Msg"));
